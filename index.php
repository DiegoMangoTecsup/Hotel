        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="txtNombres" autofocus required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Apellidos Paternos: </label>
                        <input type="text" class="form-control" name="txtDni" autofocus required>
                    </div>
                    <div class="mb-3">
                    <div class="mb-3">
                        <label class="form-label">Apellidos Maternos: </label>
                        <input type="text" class="form-control" name="txtDni" autofocus required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Fecha de nacimiento: </label>
                        <input type="date" class="form-control" name="txtDni" autofocus required>
                    </div>
                    <div>
